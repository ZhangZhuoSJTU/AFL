...
/* MDZZ Modification - Begin */
           last_cov_time,             /* Time for most recent cov (ms)    */
           total_covs,                /* Total number of covs             */
...
/* MDZZ Modification - Begin */
  sprintf(tmp, "%s", DI(total_covs));

  SAYF(bV bSTOP "    last new cov : " cRST "%-34s " bSTG bV bSTOP
       "   total covs : %-6s " bSTG bV "\n",
       DTD(cur_ms, last_cov_time), tmp);
/* MDZZ Modification - End */
...
*/
  ...
  fprintf(plot_file, "# unix_time, cycles_done, cur_path, paths_total, "
                     "pending_total, pending_favs, map_size, unique_crashes, "
                     "unique_hangs, max_depth, execs_per_sec, edge_coverage, total_execs\n");
/* MDZZ Modification - End */
